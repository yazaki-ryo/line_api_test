    ...
    <div class="col-md-6 col-md-offset-4">
        ...
        @elseif ($mode === 'edit')
            ...
            @can ('authorize', config('permissions.groups.customers.visited_histories.delete'))
                @can ('delete', $row)
                    <a href="{{ route('customers.visited_histories.delete', [$row->customerId(), $row->id()]) }}" class="btn btn-danger" onclick="common.submitFormWithConfirm('{{ route('customers.visited_histories.delete', [$row->customerId(), $row->id()]) }}'); return false;">
