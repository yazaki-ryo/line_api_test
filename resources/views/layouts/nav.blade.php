...
--}}
                @else
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true" v-pre>
                            @lang ('elements.menus.configurations') @if ($user->unreadNotifications()->count()) <span class="badge bg-danger">{{ $user->unreadNotifications()->count() }}</span> @endif <span class="caret"></span>
                        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="disabled"><a href="#">@lang ('elements.labels.notification') @if ($user->unreadNotifications()->count()) <span class="badge bg-danger">{{ $user->unreadNotifications()->count() }}</span> @endif </a></li>
