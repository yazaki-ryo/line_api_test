...
@section('meta')
    <title>@lang ('elements.pages.auth.passwords.reminder') | {{ config('app.name') }}</title>
        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-0">
                <div class="page-header">
                    	<h1 class="h2">@lang ('elements.pages.auth.passwords.reminder') <small><code>@lang ('Sub text')</code></small></h1>
                </div>
            </div>
        </div>
