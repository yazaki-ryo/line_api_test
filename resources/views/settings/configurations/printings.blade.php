...
@section('meta')
    <title>@lang ('elements.words.print')@lang ('elements.words.set') | {{ config('app.name') }}</title>
        ...
        <div class="row">
            <div class="col-md-12 col-md-offset-0">
                <div class="page-header">
                    	<h1 class="h2">@lang ('elements.words.print')@lang ('elements.words.set') <small><code>@lang ('Sub text')</code></small></h1>
                </div>
            </div>
        </div>
