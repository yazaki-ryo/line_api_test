<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'address_x') ? ' has-error' : '' }}">
...
<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'address_y') ? ' has-error' : '' }}">
    <label for="{{ $attribute }}" class="col-md-5 control-label">
        @lang (sprintf('attributes.settings.printings.%s', $attribute))
        <span class="label label-danger">@lang ('elements.words.required')</span>
    </label>
...
<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'address_font') ? ' has-error' : '' }}">
    <label for="{{ $attribute }}" class="col-md-5 control-label">
        @lang (sprintf('attributes.settings.printings.%s', $attribute))
        <span class="label label-danger">@lang ('elements.words.required')</span>
    </label>
...
<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'address_font_size') ? ' has-error' : '' }}">
    <label for="{{ $attribute }}" class="col-md-5 control-label">
        @lang (sprintf('attributes.settings.printings.%s', $attribute))
        <span class="label label-danger">@lang ('elements.words.required')</span>
    </label>
