<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'name_x') ? ' has-error' : '' }}">
...
<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'name_y') ? ' has-error' : '' }}">
    <label for="{{ $attribute }}" class="col-md-5 control-label">
        @lang (sprintf('attributes.settings.printings.%s', $attribute))
        <span class="label label-danger">@lang ('elements.words.required')</span>
    </label>
...
<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'name_font') ? ' has-error' : '' }}">
    <label for="{{ $attribute }}" class="col-md-5 control-label">
        @lang (sprintf('attributes.settings.printings.%s', $attribute))
        <span class="label label-danger">@lang ('elements.words.required')</span>
    </label>
...
<div class="form-group{{ $errors->{$errorBag ?? 'default'}->has($attribute = 'name_font_size') ? ' has-error' : '' }}">
    <label for="{{ $attribute }}" class="col-md-5 control-label">
        @lang (sprintf('attributes.settings.printings.%s', $attribute))
        <span class="label label-danger">@lang ('elements.words.required')</span>
    </label>
