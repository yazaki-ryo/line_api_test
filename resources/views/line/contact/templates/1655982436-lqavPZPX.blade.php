...
<div>
    <select name="order_menu">
        <option value="おまかせ料理 7,000円">おまかせ料理 7,000円(税別)</option>
        <option value="おまかせ料理 10,000円">おまかせ料理 10,000円(税別)</option>
        <option value="おまかせ料理 15,000円">おまかせ料理 15,000円(税別)</option>
